...
export const ARMOR_CATALOG: Record<string, ArmorTemplate> = {
  ...
  metalgear_helmet: template(
    ...
    100,
    "P",
    "MetalGear laminated expoxide helmet with face shield.",
    { shortName: "MG Helmet" },
  ),
  metalgear_chest: template(
    "metalgear_chest",
    "MetalGear Chest",
    "hard",
    25,
    ...
    100,
    "P",
    "MetalGear torso and back clamshell section.",
    { shortName: "MG Chest", ev: 2 },
  ),
  metalgear_arm_covers: template(
    "metalgear_arm_covers",
    "MetalGear Arm Covers",
    "hard",
    25,
    arms,
    100,
    "P",
    "MetalGear laminated expoxide arm coverings.",
    { shortName: "MG Arms", ev: 2 },
  ),
  metalgear_leg_covers: template(
    "metalgear_leg_covers",
    "MetalGear Leg Covers",
    "hard",
    25,
    legs,
    100,
    "P",
    "MetalGear laminated expoxide leg coverings.",
    { shortName: "MG Legs", ev: 2 },
  ),
  nkvbda: template(
    "nkvbda",

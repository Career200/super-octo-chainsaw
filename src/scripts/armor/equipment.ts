...
export const armorTemplates: Record<string, ArmorTemplate> = {
  ...
  armored_hood: template("armored_hood", "Ballistic Hood", "soft", 8, head, {
    cost: 30,
  }),
  street_pants: template(
    "street_pants",
  ...
  // --- TACTICAL SOFT ---
  tac_vest: template("tac_vest", "Tactical Vest", "soft", 18, torsoArms, {
    cost: 150,
  }),
  riot_suit_soft: template(
    "riot_suit_soft",
    "Riot Suit (Soft)",
    "soft",
    16,
  ...
  // --- HARD TORSO ---
  plate: template("plate", "Ceramic Plate", "hard", 25, torso, {
    cost: 300,
    ev: 1,
  }),
  steel_plate: template(
    "steel_plate",
    "Steel Trauma Plate",
    "hard",
    28,
  ...
  visor_mask: template("visor_mask", "Ballistic Visor Mask", "soft", 10, head, {
    cost: 60,
  }),

  // --- FULL SUITS ---
  flak_suit: template("flak_suit", "Flak Combat Suit", "soft", 20, fullBody, {
    cost: 400,
  }),
  corp_sec_suit: template(
    "corp_sec_suit",

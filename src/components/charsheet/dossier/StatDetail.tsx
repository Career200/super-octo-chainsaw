...
import { setStatBonus, setStatInherent } from "@stores/stats";
...
export function StatDetail({ name, values }: Props) {
  const isOverridden = values.override != null;
      ...
      <div class="detail-stats">
        {isOverridden ? (
          <span class="detail-stat">
            <span class="detail-label">Override</span>
            <span class="stat-detail-cyber">{values.override}</span>
          </span>
        ) : (
          <>
            ...
            {values.cyber !== 0 && (
              <span class="detail-stat">
                ...
                <span class="stat-detail-cyber">
                  {values.cyber > 0 ? `+${values.cyber}` : values.cyber}
                </span>
              </span>
            )}
          </>
          ...
          <input
            ...
            onInput={(e) =>
              setStatBonus(
                ...
                Math.min(
                  10,
                  Math.max(-10, parseInt(e.currentTarget.value, 10) || 0),
                ),
              )
            }
          />
